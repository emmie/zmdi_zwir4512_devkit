...
typedef
  enum {
    ZWIR_UART2_eOvfl = 0x0220,
    ZWIR_UART2_eParity,
    ZWIR_UART2_eFrame,
    ZWIR_UART2_eNoise
  } ZWIR_UART2_ErrorCode_t;
 ...
 ** *************************************************************************/
bool
  ZWIR_UART2_SendByte ( uint8_t  data );
 ...
 ** *************************************************************************/
bool
  ZWIR_UART2_ReadByte ( uint8_t*  data );
 ...
 ** *************************************************************************/
void
  ZWIR_UART2_SetRXCallback ( ZWIR_UART_RXCallback_t  callback );
 ...
 ** *************************************************************************/
void
  ZWIR_UART2_Setup ( uint32_t  baudRate,
                     uint8_t   parameters );
 ...
 ** *************************************************************************/
uint16_t
  ZWIR_UART2_GetAvailableTXBuffer ( void );
...
void  __attribute__ (( deprecated ))
  ZWIR_UART2_Configure (  ZWIR_UART_Parameter_t  parameter,
                          uint32_t               value );

// for backward compatibility
static __attribute__ (( deprecated )) ZWIR_UART2_ErrorCode_t const ZWIR_eUART2_Ovfl = ZWIR_UART2_eOvfl;
static __attribute__ (( deprecated )) ZWIR_UART2_ErrorCode_t const ZWIR_eUART2_Parity = ZWIR_UART2_eParity;
static __attribute__ (( deprecated )) ZWIR_UART2_ErrorCode_t const ZWIR_eUART2_Frame = ZWIR_UART2_eFrame;
static __attribute__ (( deprecated )) ZWIR_UART2_ErrorCode_t const ZWIR_eUART2_Noise = ZWIR_UART2_eNoise;


//! Provide a __putchar implementation which can be used by printf.
#define ZWIR_UART2_PRINTF                \
uint8_t                                                   \
__putchar ( uint8_t  c ) {                                \
  while ( !ZWIR_UART2_SendByte ( c ) );  \
  return  c;                                              \
}
